...
Useful resources
MDN — CSS clamp() - Helped me make font sizes and padding scale smoothly across devices without needing extra breakpoints.
CSS Tricks — A Complete Guide to Flexbox - A great reference whenever I needed to revisit flex alignment.
AI Collaboration
